...
(when (or (>= emacs-major-version 25)
  ...
  (use-package abyss-theme :ensure t :pin melpa :defer t)
  (use-package afternoon-theme :ensure t :pin melpa :defer t)
  (use-package ahungry-theme :ensure t :pin melpa :defer t)
  (use-package alect-themes :ensure t :pin melpa :defer t)
  (use-package ample-theme :ensure t :pin melpa :defer t)
  (use-package ample-zen-theme :ensure t :pin melpa :defer t)
  (use-package anti-zenburn-theme :ensure t :pin melpa :defer t)
  (use-package arjen-grey-theme :ensure t :pin melpa :defer t)
  (use-package atom-dark-theme :ensure t :pin melpa :defer t)
  (use-package atom-one-dark-theme :ensure t :pin melpa :defer t)
  ...
  (use-package calmer-forest-theme :ensure t :pin melpa :defer t)
  (use-package caroline-theme :ensure t :pin melpa :defer t)
  ...
  (use-package darkmine-theme :ensure t :pin melpa :defer t)
  ...
  (use-package hc-zenburn-theme :ensure t :pin melpa :defer t)
  (use-package hemisu-theme :ensure t :pin melpa :defer t)
  (use-package hemera-theme :ensure t :pin melpa :defer t)
  (use-package heroku-theme :ensure t :pin melpa :defer t)
  ...
  (use-package modus-operandi-theme :ensure t :pin melpa :defer t)
  (use-package modus-vivendi-theme :ensure t :pin melpa :defer t)
  ...
  (use-package sublime-themes :ensure t :pin melpa :defer t)
  (use-package sunny-day-theme :ensure t :pin melpa :defer t)
  (use-package tango-plus-theme :ensure t :pin melpa :defer t)
