...
winget install --silent --exact --id Microsoft.VisualStudio.2022.Community --accept-package-agreements --accept-source-agreements
if %ERRORLEVEL% NEQ 0 echo "error: failed to install Microsoft.VisualStudio.2022.Community."
